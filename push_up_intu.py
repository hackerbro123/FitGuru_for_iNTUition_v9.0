    ...
    while True:
        ...
        if results.pose_landmarks:
            ...
            if left_hip_angle <152.5  and right_hip_angle <152.5 :
                ...
                is_squat = False
        cv2.putText(annotated_frame, f'Push Up Counter: {pushup_counter}', (600, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        if is_pushup:
            cv2.putText(annotated_frame, f'UP', (500, 600), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
        else:
            cv2.putText(annotated_frame, f'DOWN', (500, 600), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
